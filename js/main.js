      ...
      if(possibilities.length === 0) {
        ...
        if(methodSwitch < ADD_PROBABILITY) { //add a problem
          ...
          if(problem.offset().top < $(window).scrollTop()) {
            ...
            console.log('above!');
            console.log('original is ' + originalHeight);
            console.log('addition is ' + parseInt(problemHeight + 16));
            $('.main').scrollTop( originalHeight + problemHeight + ADDED_HEIGHT); //add 1rem, who knows why
            console.log('new is ' + $('.main').scrollTop());
          } else {
            console.log('below!');
          }
